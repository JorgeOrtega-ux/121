...
<head>
    ...
    <?php // <!-- Estilos del visor de fotos (sin cambios) --> ?>
    <style>
...
<body>
    ...
    <script>
        ...
        // Inyectamos el auth_token de la sesión de PHP para que JS lo use.
        window.userAuthToken = '<?php echo $_SESSION['auth_token'] ?? ''; ?>'; 
        // --- ▲▲▲ FIN DE MODIFICACIÓN ▲▲▲ ---
