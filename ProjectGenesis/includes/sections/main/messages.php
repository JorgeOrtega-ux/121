...
// --- ▼▼▼ INICIO DE MODIFICACIÓN (Añadir rol) ▼▼▼ ---
$preloadedRole = 'user'; 
// --- ▲▲▲ FIN DE MODIFICACIÓN ▲▲▲ ---
...
if ($hasPreloadedUser) {
    ...
    // --- ▼▼▼ INICIO DE MODIFICACIÓN (Guardar rol) ▼▼▼ ---
    $preloadedRole = htmlspecialchars($preloadedChatUser['role']);
    // --- ▲▲▲ FIN DE MODIFICACIÓN ▲▲▲ ---

    // --- ▼▼▼ INICIO DE MODIFICACIÓN (LÓGICA DE ROL/ESTADO CORREGIDA) ▼▼▼ ---
    
    // Como ya no hay comunidades, solo comprobamos el estado online.
    // Usamos isset() para evitar el warning si el router no la define.
    $is_online = isset($is_actually_online) && $is_actually_online;

    if ($is_online) { 
        $preloadedStatusText = 'Online';
        $preloadedStatusClass = 'online active';
    } else {
        // Si no está online (o la variable no se definió), muestra el "last_seen"
        $preloadedStatusText = getChatTimeAgo($preloadedChatUser['last_seen']);
        $preloadedStatusClass = 'active'; // Visible, pero sin "online"
    }

    // --- ▲▲▲ FIN DE MODIFICACIÓN (LÓGICA DE ROL/ESTADO CORREGIDA) ▲▲▲ ---
    ...
    <div class="chat-layout-container <?php echo $chatLayoutClass; ?>" id="chat-layout-container">
        ...
        <div class="chat-sidebar-left <?php echo $chatSidebarClass; ?>" id="chat-sidebar-left">
            ...
            <div class="chat-sidebar-filters" id="chat-sidebar-filters">
                ...
                <button type="button" class="chat-filter-badge" data-filter="unread" data-i1imprimirá-i18n="chat.filter.unread">No leídos</button>
        ...
        <div class="chat-content-right" id="chat-content-right">
            ...
            <div class="chat-content-main <?php echo $chatContentMainClass; ?>"
                ...
                <div class="chat-content-header">
                    ...
                    <div class="chat-header-left">
                        ...
                        <?php // --- ▼▼▼ INICIO DE MODIFICACIÓN (Añadido data-role) ▼▼▼ --- ?>
                        <div class="chat-header-avatar" 
                             data-role="<?php echo $preloadedRole; ?>" 
                             style="<?php echo ($preloadedChatUser['role'] === 'community') ? 'border-radius: 8px;' : ''; ?>">
                    ...
                    <div class="chat-header-right">
                        <button type="button" class="chat-header-options-button" id="chat-header-options-button" data-action="toggleModuleChatHeaderOptions" title="Más opciones">
                ...
                <form class="chat-message-input-form" id="chat-message-input-form" action="#">
                    ...
                    <div class="chat-input-pill-wrapper">
                        ...
                        <div class="chat-input-main-column active"> 
                            <textarea
                        ...
                        <div class="chat-input-main-row active"> 
                            ...
                            <button type="button" class="chat-attach-button" id="chat-attach-menu-button" data-action="toggleModuleChatAttach">
            ...
            <div class="popover-module body-title disabled"
                 data-module="moduleChatAttach"
                 id="chat-attach-popover">
                <div class="menu-content">
                    <div class="menu-list">
                        <div class="menu-link" data-action="chat-attach-photos">
                            <div class="menu-link-icon"><span class="material-symbols-rounded">photo_library</span></div>
                            <div class="menu-link-text"><span>Agregar fotos</span></div>
                        </div>
                        </div>
                </div>
            </div>
            ...
            <div class="popover-module body-title disabled"
                ...
                <div class="menu-content">
                    <div class="menu-list">
                        ...
                        <div class="menu-link" data-action="msg-delete" style="display: none;"> 
            ...
            <div class="popover-module body-title disabled"
                 data-module="moduleChatHeaderOptions"
                 id="chat-header-options-menu">
                <div class="menu-content">
                    <div class="menu-list">
                        <div class="menu-link" data-action="chat-header-view-profile">
                            <div class="menu-link-icon"><span class="material-symbols-rounded">person</span></div>
                            <div class="menu-link-text"><span>Info del amigo</span></div>
                        </div>
                        <div class="menu-link" data-action="chat-header-delete-chat">
                            <div class="menu-link-icon" style="color: #c62828;"><span class="material-symbols-rounded">delete</span></div>
                            <div class="menu-link-text"><span style="color: #c62828;">Eliminar conversación</span></div>
                        </div>
                    </div>
                </div>
            </div>
