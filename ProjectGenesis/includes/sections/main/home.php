...
<div class="section-content overflow-y <?php echo ($CURRENT_SECTION === 'home') ? 'active' : 'disabled'; ?>" data-section="home">
    ...
    <div class="component-wrapper">
        ...
        <?php // --- INICIO: Formulario para crear publicación --- ?>
        <form class="component-card post-comment-input-container" data-action="profile-post-submit" style="padding: 16px;">
            ...
            <?php // Asigna el ID de la comunidad actual, o vacío si es el feed principal ?>
            <input type="hidden" name="community_id" value="<?php echo ($communityUuid !== null) ? htmlspecialchars($currentCommunityId) : ''; ?>"> 
            ...
            <input type="text" 
                   ...
                   name="text_content" 
                   placeholder="¿En qué estás pensando, <?php echo htmlspecialchars($_SESSION['username'] ?? 'tú'); ?>?" 
                   data-i18n-placeholder="home.main.postPlaceholder" <?php // Para traducción JS ?>
                   required 
                   autocomplete="off" 
                   maxlength="1000">
        ...
        <?php // --- FIN: Formulario para crear publicación --- ?>
