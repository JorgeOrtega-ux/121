...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'get-conversations') {
            ...
            // --- ▼▼▼ INICIO DE MODIFICACIÓN (PHP) ▼▼▼ ---
            // 1. Obtener la lista de usuarios online REAL del socket server
            $onlineUserIds = [];
            try {
            ...
            // --- ▲▲▲ FIN DE MODIFICACIÓN (PHP) ▲▲▲ ---


            // --- ▼▼▼ INICIO DE MODIFICACIÓN (SQL) ▼▼▼ ---
            // Se elimina u.is_online de la consulta
            ...
            foreach ($friends as &$friend) {
                ...
                // --- ▼▼▼ INICIO DE MODIFICACIÓN (PHP) ▼▼▼ ---
                // 2. Usar la lista $onlineUserIds en lugar de la columna de la BD.
